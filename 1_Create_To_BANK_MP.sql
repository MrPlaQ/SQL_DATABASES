/* Otwieramy DBMS, ustawiamy się na gałęzi "Master" i poprzez nowe zapytanie tworzymy skryptem nową bazę w sekcji "Databases" */

CREATE DATABASE BANK_MP;

/* Odświeżamy foldery, przestawiamy się na gałąź naszego banku i znów poprzez nowe zapytanie aktywujemy skrypt tworzący zbudowany w PowerDesigner, tworząc tym samym strukturę tabel i ich relacje. */
